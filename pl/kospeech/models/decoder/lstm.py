...
from kospeech.models.modules.modules import Linear, View
from kospeech.models.modules.attention import (
...
class DecoderLSTM(IncrementalDecoder):
    """
...
class BeamDecoderRNN(BaseDecoder):
    ...
    def __init__(self, decoder: DecoderLSTM, beam_size: int, batch_size: int):
