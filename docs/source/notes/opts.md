...
main.py
```
usage: main.py [-h] [--dataset_path] [--data_list_path] 
               [--label_path] [--noiseset_size]
               [--use_cuda] [--use_multi_gpu]
               [--spec_augment] [--noise_augment] 
               [--noise_level] [--dropout]
               [--use_bidirectional] [--init_uniform] 
               [--batch_size] [--num_epochs] 
               [--num_workers] [--valid_ratio]
               [--init_lr] [--rampup_period]
               [--high_plateau_lr] [--low_plateau_lr]
               [--max_len] [--max_grad_norm]
               [--decay_threshold] [--exp_decay_period]
               [--num_heads] [--attn_mechanism] 
               [--rnn_type] [--label_smoothing]
               [--listener_layer_size] [--speller_layer_size] 
               [--seed] [--teacher_forcing_ratio] 
               [--teacher_forcing_step] [--min_teacher_forcing_ratio] 
               [--save_result_every] [--checkpoint_every]
               [--print_every] [--sample_rate]
               [--window_size] [--stride] 
               [--feature_extract_by] [--n_mels]
               [--del_silence] [--input_reverse]
               [--time_mask_para] [--freq_mask_para]
