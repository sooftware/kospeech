...
from kospeech.models.interface import (
    EncoderInterface,
    DecoderInterface,
    EncoderDecoderModelInterface,
    CTCModelInterface,
)
...
class BaseEncoderDecoderModel(EncoderDecoderModelInterface):
    """
...
class BaseCTCModel(CTCModelInterface):
    """
    ...
    @torch.no_grad()
    def recognize(self, inputs: Tensor, input_lengths: Tensor) -> Tensor:
        predicted_log_probs = self.forward(inputs, input_lengths)[0]
