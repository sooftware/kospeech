...
[Soohwan Kim](https://github.com/sooftware) designed and implemented system, [Seyoung Bae](https://github.com/triplet02) reviewed source code,     
[Cheolhwang Won](https://github.com/wch18735) experimented signal processing and [Suwon Park](https://ei.kw.ac.kr/introduction/professor_view.php?idx=72) is advisor to this work.  
