...
So far, Fice models are implemented: *Deep Speech 2, Listen Attend and Spell (LAS), Speech Transformer, Joint CTC-Attention LAS, and Joint CTC-Attention Transformer*. To check details of these model architectures, check figures attached to each section.
