...
Or refer [here](https://github.com/sooftware/End-to-end-Speech-Recognition/wiki/Preparation-before-Training). this document contains information regarding the preprocessing of `KsponSpeech`  
